 ...
 * @author PC-CASA
 */
@WebServlet(name = "CadastroPostServlet", urlPatterns = {"/cadastropostservlet.do"})
public class CadastroPostServlet extends HttpServlet {
...
//        String = request.getParameter("");
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CadastroPostServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            for(String pac : s){
            out.println("<h1>Servlet CadastroPostServlet at " + pac + "</h1>");
            }
            out.println("<h1>Servlet CadastroPostServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
