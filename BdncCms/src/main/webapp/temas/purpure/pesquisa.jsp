<%-- 
    Document   : index.jsp
    Created on : 07/05/2017, 20:47:58
    Author     : PC-CASA
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="pt-br"> <!--<![endif]-->
    ...
    <body>
       ...
       <!--         <form class="navbar-form navbar-left">
        ...
        <div class="container">
            <c:forEach var="post" items="${PaginasPesquisadas}">
                <section class="container-center">
                    <article><a href="../../recuperarpaginaservlet.do?param=${post.id}&param2=temas/purpure/index.jsp"><h1>${post.titulo}</h1></a></article><hr>
