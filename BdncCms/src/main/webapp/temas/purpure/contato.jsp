<%-- 
    Document   : contato
    Created on : 08/05/2017, 21:03:10
    Author     : PC-CASA
--%>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="pt-br"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="container">
                ...
                <div class="content">
                    <form  method="" action="" class="form-search">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control for" placeholder="Nome">
                            <input type="text" class="form-control for" placeholder="Email">
                            <input type="text" class="form-control for" placeholder="Assunto">
                            <textarea type="text" class="form-control" rows="25" placeholder="Mensagem"></textarea>
            ...
            <aside style="">
                <form  method="post" action="../../pesquisapostservlet.do" class="form-search">
                    <div class="form-group">
